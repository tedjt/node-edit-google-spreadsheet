...
Metadata.prototype.extract = function(result) {
  return {
    updated: new Date(result.entry.updated.$t || result.entry.updated),
    title: result.entry.title.$t || result.entry.title,
    rowCount: parseInt(result.entry['gs:rowCount'] || result.entry.gs$rowCount.$t, 10),
    colCount: parseInt(result.entry['gs:colCount'] || result.entry.gs$colCount.$t, 10)
  };
};
